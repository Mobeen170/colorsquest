...
android {
    ...
    buildTypes {
        release {
            // Never produce a store artifact signed with Flutter's public
            // debug key. A local, gitignored android/key.properties selects
            // the owner's existing upload keystore when it is available.
            if (hasReleaseSigning) {
